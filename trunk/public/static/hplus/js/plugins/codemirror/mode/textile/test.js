...
(function() {
  ...
  MT('image',
      'An image: [string !http://www.example.com/hot-1.png!]');

  MT('imageWithAltText',
      'An image: [string !http://www.example.com/hot-1.png (Alt Text)!]');

  MT('imageWithUrl',
      'An image: [string !http://www.example.com/hot-1.png!:http://www.example.com/]');
