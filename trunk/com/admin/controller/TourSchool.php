...
class TourSchool extends Base{
    ...
    public function updateTops() {
        ...
        if(isset($id) && isset($field) && isset($value)){foreach($Model->where('is_top',1)->select() as $k=>$v){$Model->save(array('is_top'=>2),['id'=>$v['id']]);}
